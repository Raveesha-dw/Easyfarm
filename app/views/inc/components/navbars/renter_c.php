...
<script>
    $(document).ready(function(){
        ...
        setActiveLink('.link[href="http://localhost/Easyfarm/V_renter_home/get_details3"]');
...
<div class="homeheader">
    <a href="http://localhost/Easyfarm/V_renter_home/get_details1" class="link">NEW ORDERS</a>
