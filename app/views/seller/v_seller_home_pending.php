 ...
 <div class ="msg-box">
       ...
       <div class="msg-f"> 
                     ...
                     <div class="msg-f-detail">
                            ...
                            <button class="dd"> <a href="http://localhost/Easyfarm/Seller_home/update_status2?id=<?php echo $product->Order_ID; ?>" onclick="changeText(this)" ><?php echo $product->Status; ?> </a> </button>
