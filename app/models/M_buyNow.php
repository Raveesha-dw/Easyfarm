...
class M_buyNow{
    ...
    public function getItemDetais($data){
        ...
        $this->db->query('SELECT I.Item_name, I.DeliveryMethod, I.Unit_price, I.Unit_type, I.Unit_size, S.Store_Name FROM item I INNER JOIN reg_seller S ON I.seller_ID=S.U_Id WHERE I.Item_Id = :Item_Id');
